<template>
  <div class="flex lg:items-center lg:flex-row flex-col pt-2 pb-1.8 border-b border-black-10 border-1 md:pr-2.5 last:border-0">
    ...
    <div class="flex lg:mt-0 mt-2 lg:items-center">
      ...
      <button type="button"  class="flex items-center" @click="showModalQr">
        <SvgIcon name='qr'/>
      </button>
    </div>
  </div>
